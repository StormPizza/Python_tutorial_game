...
def print_level_bar(player, world):
    level_text = "LEVEL " + str(world[current_level])
    # if isinstance(current_level, basestring):
    #     level_text = ""
    if world[store_open] == "open":
        level_text = "STORE // " + "LEVEL " + str(world[current_level])
...
# def make_rooms_power():
#     power = calc_monster_attack(current_level)
#     # power = {"q": 5,"w": 7, "e": 99}
#
#     # effect = "Effect: "
#     # wait_power = "Skip this lvl"
#     # skill_power = ""
...
#     for code in list_order:
#         if power[code] != "":
#             rooms_power1[code] = monster_text
#         else:
#             rooms_power1[code] = ability_text
#
#         if power[code] != "":
#             rooms_power2[code] = power_text + power[code]
#         else:
#             rooms_power2[code] = ""
#
#     return rooms_power1, rooms_power2


    # rooms_power1['w'] = monster_text
    # rooms_power1['e'] = monster_text
    # rooms_power1['r'] = ability_text
    # rooms_power1['a'] = ability_text

    # rooms_power2 = {}
    # rooms_power2['q'] = power_text + power['q']
    # rooms_power2['w'] = power_text + power['w']
    # rooms_power2['e'] = power_text + power['e']
    # rooms_power2['r'] = ""
    # rooms_power2['a'] = ""

    # for code, monster_power in rooms_power.items():
    #     foe_desc = ""
    #     if monster_power:
    #         foe_desc = "Foe Power: "
    #     newpower = toolz.add_space(str(monster_power), maxlen, foe_desc)
    #     index_number = toolz.get_correct_index(list_order, code)
    #     # print index_number
    #     set3[index_number] = newpower
    # return rooms_power1, rooms_power2
